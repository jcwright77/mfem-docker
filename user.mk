...
CXX = g++ -Wl,-rpath,$(HOME)/lib
MPICXX = mpicxx -Wl,-rpath,$(HOME)/lib

OPTIM_FLAGS = -O3 -std=c++11 -Wno-literal-suffix
DEBUG_FLAGS = -g -Wall -std=c++11 -Wno-literal-suffix
...
HYPRE_DIR = /home/user
# @MFEM_DIR@/../hypre-2.10.0b/src/hypre
HYPRE_OPT = -I$(HYPRE_DIR)/include
HYPRE_LIB = -Wl,-rpath,$(HYPRE_DIR)  -L$(HYPRE_DIR)/lib -lHYPRE
...
ifeq ($(MFEM_USE_SUPERLU)$(MFEM_USE_STRUMPACK),NONO)
   ...
   METIS_DIR = /home/user
#@MFEM_DIR@/../parmetis-4.0.3
   METIS_OPT = -I$(METIS_DIR)/include
   METIS_LIB = -Wl,-rpath,$(METIS) -L$(METIS_DIR)/lib -lparmetis -lmetis
...
SUPERLU_LIB = -Wl,-rpath,$(SUPERLU_DIR)/SRC -L$(SUPERLU_DIR)/lib -lsuperlu_dist -lblas
